...
public class MalePageTwo extends Activity implements OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.pp_activity_male_page_one_2);
		
		setTitle("Male Page 2 ID:" + Utils.getPersonId(getApplicationContext()));
	...
	public void onResume()
	{
		...
		if(sharedPreferences.getString("heightMale", "").equals("")==false && sharedPreferences.getString("heightMale", "").equalsIgnoreCase("null")==false)
		{
			editTextHeight.setText(sharedPreferences.getString("heightMale", ""));
		}

		if(sharedPreferences.getString("weightMale", "").equals("")==false && sharedPreferences.getString("weightMale", "").equalsIgnoreCase("null")==false)
		{
            editTextWeight.setText(sharedPreferences.getString("weightMale", ""));
		}
	...
	public void onClick(View view) {
		...
		case R.id.nextButton:
			...
			if(validateData()){
				...
				Intent i = new Intent(MalePageTwo.this, MalePageThree.class);
				startActivity(i);
				finish();
			}
		...
		case R.id.backButton:
			Intent i = new Intent(MalePageTwo.this, MalePageOne.class);
			startActivity(i);
			finish();
	...
	private void setDraftStatus(){
		...
		spEditor.putString("personDraftWhere",  Constants.MalePageTwo_DRAFT_WHERE);
		spEditor.commit();
	}
	...
	private void updateSharedPreferrence(){
		...
		spEditor.putString("typeOfDisability",  ViewUtils.getEditTextInput(typeOfDisabilityET));
		...
		spEditor.putString("heightMale",  ViewUtils.getEditTextInput(editTextHeight));
		spEditor.putString("weightMale",  ViewUtils.getEditTextInput(editTextWeight));
    ...
    private class MaleHttpAsyncTask extends AsyncTask<Void, Void, Boolean> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			progressDialog = new ProgressDialog(MalePageTwo.this);
