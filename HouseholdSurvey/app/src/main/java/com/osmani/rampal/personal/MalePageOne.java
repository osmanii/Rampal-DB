...
public class MalePageOne extends Activity implements OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setTitle("Male Page 1 ID:" + Utils.getPersonId(getApplicationContext()));
	...
	public void onClick(View view) {
		...
		case R.id.nextButton:
			...
			if(validateData()){
				...
				Intent i = new Intent(MalePageOne.this, MalePageTwo.class);
				startActivity(i);
				finish();
			}
		...
		case R.id.backButton:
			Intent i = new Intent(MalePageOne.this, PPFifthPage.class);
			startActivity(i);
			finish();
	...
	private void setDraftStatus(){
		...
		spEditor.putString("personDraftWhere",  Constants.MalePageOne_DRAFT_WHERE);
		spEditor.commit();
	}
    ...
    private class MaleHttpAsyncTask extends AsyncTask<Void, Void, Boolean> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			progressDialog = new ProgressDialog(MalePageOne.this);
